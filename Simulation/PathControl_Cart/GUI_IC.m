...
% Last Modified by GUIDE v2.5 23-Nov-2016 17:40:07
...
set(handles.F1_IC, 'String', 0);
set(handles.F2_IC, 'String', 0);
set(handles.F3_IC, 'String', 0);
set(handles.F4_IC, 'String', 0);
...
function F1_IC_Callback(hObject, eventdata, handles)
% hObject    handle to F1_IC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of F1_IC as text
%        str2double(get(hObject,'String')) returns contents of F1_IC as a double


% --- Executes during object creation, after setting all properties.
function F1_IC_CreateFcn(hObject, eventdata, handles)
% hObject    handle to F1_IC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function F2_IC_Callback(hObject, eventdata, handles)
% hObject    handle to F2_IC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of F2_IC as text
%        str2double(get(hObject,'String')) returns contents of F2_IC as a double


% --- Executes during object creation, after setting all properties.
function F2_IC_CreateFcn(hObject, eventdata, handles)
% hObject    handle to F2_IC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function F3_IC_Callback(hObject, eventdata, handles)
% hObject    handle to F3_IC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of F3_IC as text
%        str2double(get(hObject,'String')) returns contents of F3_IC as a double


% --- Executes during object creation, after setting all properties.
function F3_IC_CreateFcn(hObject, eventdata, handles)
% hObject    handle to F3_IC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function F4_IC_Callback(hObject, eventdata, handles)
% hObject    handle to F4_IC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of F4_IC as text
%        str2double(get(hObject,'String')) returns contents of F4_IC as a double


% --- Executes during object creation, after setting all properties.
function F4_IC_CreateFcn(hObject, eventdata, handles)
% hObject    handle to F4_IC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
F1 = str2num(get(handles.F1_IC, 'String'));
F2 = str2num(get(handles.F2_IC, 'String'));
F3 = str2num(get(handles.F3_IC, 'String'));
F4 = str2num(get(handles.F4_IC, 'String'));


% Saves all the variables from above into a structure called "IC"
IC = struct('P',(P),'Q',(Q),'R',(R),'Phi',(Phi),'The',(The),'Psi',(Psi),...
    'U',(U),'V',(V),'W',(W),'X',(X),'Y',(Y),'Z',(Z),'F1',(F1),'F2',(F2),...
    'F3',(F3),'F4',(F4));
...
set(handles.F1_IC,'String',IC.F1);
set(handles.F2_IC,'String',IC.F2);
set(handles.F3_IC,'String',IC.F3);
set(handles.F4_IC,'String',IC.F4);
